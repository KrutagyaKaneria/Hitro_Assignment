...
export function StatsCard({ label, value, icon: Icon, iconClassName }: Props) {
  return (
    <div className="flex h-[54px] w-full max-w-[160px] items-center gap-2.5 rounded-lg border border-border bg-surface px-2.5 py-2 transition-shadow duration-200 hover:shadow-sm lg:h-20 lg:max-w-none lg:min-w-0 lg:flex-1 lg:gap-3 lg:px-4 lg:py-3">
      <div
        className={cn(
